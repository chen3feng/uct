...
class DefaultKeys:
    ...
    Attributes:
        ...
        cancel(List[str]): Keys that cancel list element selection.
        ...
        home(List[str]): Keys that select the first element below.
        end(List[str]): Keys that select the last element above.
    """
...
def select(
    ...
    while True:
        ...
        if keypress in DefaultKeys.up:
            ...
            if selected_index == -1:
                selected_index = last_selectable()
            ...
            break
        elif keypress in DefaultKeys.cancel:
            selected_index = -1
            break
